...
\chapter{Moderne Rendering-Pipeline}
    ...
    \label{sec:Geometry Stage}
        ...
        Löschung!!) und mit Hilfe von Daten (Lichtposition, Transformationsmatrix) bearbeitet.
        Typische Aufgabe dieser Stufe ist die Modell-View-Transformation des einkommenden Eckpunktes. 
        Somit können Teile der Leuchtungsberechnung ("Gouraud shading") hier angewandt werden.
