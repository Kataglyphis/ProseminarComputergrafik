...
Der neu vorgestellte Mesh Shader\cite{taskshader} nimmt nun das detailreiche Modell
entgegen und zerlegt dieses in einzeln \textit{Meshlets}. In diesen eizelnen \textit{Meshlets} wird nun die Optimierung angewandt.
