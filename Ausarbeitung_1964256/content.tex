...
\chapter{Moderne Rendering-Pipeline}
    ...
    \label{sec:Rasterisierung}
        \begin{figure}[H]
            \centering
            \def\svgwidth{\columnwidth}
            \import{Bilder/}{Rasterisierung2.pdf_tex}
...
Der Mesh Shader nimmt die arbeitet entgegen und arbeitet ähnlich dem Compute Shader~\ref{sec:Compute Shader} auf einer Threadgruppe(hier langt jedoch ein
eindimesnsionales Array). Es gibt hier jedoch nicht nur einen gemeinsamen Speicher, sondern auch einen Output, welcher jedoch frei-programmierbar ist.
