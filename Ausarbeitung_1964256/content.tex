...
für sich auf einen VBO zeigt. Diese Aufteilung gibt uns ein besseres Wiederverwenden der Eckpunkte und daher wird Bandbreite gespart!
...
da sich die Buffer selber beschreiben lassen. So kann der Task Shader mit der Control Shader Einheit der bisherigen Tessellation verglichen werden. 
Anstatt einzelne Dreiecke einzeln zu berechnen wie in der bisherigen Pipeline können wir mehrere gleichzeitig
bearbeiten in sogenannten parallelen Thread-Gruppen. \par
