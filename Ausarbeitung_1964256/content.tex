...
\chapter{Moderne Rendering-Pipeline}
    ...
    \label{sec:Geometry Stage}
        ...
        Clipping, View-Port-Transform\ref{subsec:Viewport Transform}! Nach dem Clipping befinden wir uns im Window Space.
    ...
    \label{sec:Per Fragment Operations}
        ...
        Mit Stencil Test können wir schlussendlich entscheiden, ob ein Fragment gezeichnet werden soll oder nicht durch den Vergleich mit einem Referenzwert und 
