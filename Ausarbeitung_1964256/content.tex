...
\chapter{Unterschied moderne und klassische Rendering-Pipeline}
    ...
    an Draw Calls zu reduzieren. Dafür kamen Vertex Array Obejekte, welche außerdem mit Index Chaching optimiert werden können.\cite{cheng2004vertex}
    Sehr aktuelle Entwicklungen~\ref{sec:Meshshader} zeigen eine erneute Steigerung der freien Konfiguerierbarkeit.
