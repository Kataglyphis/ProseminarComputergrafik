...
\chapter{Moderne Rendering-Pipeline}
    ...
    Mit der rasant steigenden Leistung heutiger Grafikhardware stieg 
    auch der Wunsch beim Anwender nach mehr Rechenleistung.
    Parallesisierbare Arbeit wird in Threadgroups eingeteilt
