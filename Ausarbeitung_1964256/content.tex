...
\chapter{Moderne Rendering-Pipeline}
    ...
    \label{sec:Geometry Stage}
        ...
        \label{subsec:Tessellation}
            ...
            Ist eine optionale teil-programmierbare Stufe zur Geometrieverfielfachung, d.h. eingehendes Primitiv wird weiter in viele Dreiecke unterteilt. Der Tessellation Control
            Shader ist voll programmierbar und damit ist die Anzahl der entstehenden Dreiecke direkt beeinflussbar. Dabei lassen sich zwei jeweils benachbarte
