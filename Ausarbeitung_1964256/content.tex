...
\chapter{Moderne Rendering-Pipeline}
    ...
    \label{sec:Fragment Shader}
        ...
        nun hier.
        Das abschließende \textit{Merging} hat eine besondere Aufgabe beim Abspeichern der Farbe für jeden Pixel im color buffer. Da der buffer bereits von dem 
        vorherigen Durchlauf Farbwerte beinhaltet ist es nun daran eine Kombination aus aktuellen Inhalt, sowie einkommende Farbe zu finden, welche wiederrum 
        im color buffer abgespeichert wird. Obwohl dieses Zusammenfügen nicht komplett freiprogrammierbar ist, hat der Programmierer dennoch etliche
        Konfigurationsmöglichekeiten die er vornehmen kann.
