...
\begin{frame}
  \frametitle{Vertex Shader}
  \lstinputlisting[label = Shading im Geometry Shader, language=GLSL]{Code/vertex_shader.c}
\end{frame}
...
\begin{frame}
  ...
  \lstinputlisting[label = Shading im Geometry Shader, language=GLSL]{Code/geometry_shading.c}
\end{frame}

\begin{frame}
  \frametitle{Geometry Shader und Shading}
  \lstinputlisting[label = Shading im Geometry Shader, language=GLSL]{Code/geometry_shading2.c}
\end{frame}
...
\begin{frame}
  ...
  \lstinputlisting[label = Shading im Geometry Shader, language=GLSL]{Code/fragment_shading.c}
...
\begin{frame}
  \frametitle{Compute Shader}
  \lstinputlisting[label = Shading im Geometry Shader, language=GLSL]{Code/compute_shader.c}
\end{frame}
