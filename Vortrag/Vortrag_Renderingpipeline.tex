...
\title[Beispiel eines ganz besonders langen Titels in der Fußzeile, der zu lang für die Zeile ist und daher umgebrochen werden muss]{Beispiel einer Titelzeile}
\subtitle{Beispiel für einen Untertitel}

\author{Jonas Heinle}

\institute{INSTITUTS- FAKULTÄTS-, ABTEILUNGSNAME}
...
\begin{frame}
  ...
  \framesubtitle{Mit Zwischenüberschriften}
...
\begin{frame}
  \frametitle{Fontgrößen}

  Die folgenden Fontgrößen sind vorgesehen:
