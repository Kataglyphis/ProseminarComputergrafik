...
\begin{frame}
  ...
  \lstinputlisting[label = Shading im Geometry Shader, language=C]{Code/vertex_shader.c}
\end{frame}
...
\begin{frame}
  \frametitle{Geometry Shader und Shading}
  \lstinputlisting[label = Shading im Geometry Shader, language=C]{Code/geometry_shading2.c}
\end{frame}
...
\begin{frame}
  \frametitle{Rasterisierung}
  \lstinputlisting[label = Shading im Geometry Shader, language=C]{Code/fragment_shading.c}
...
\begin{frame}
  \frametitle{Compute Shader}
  \lstinputlisting[label = Shading im Geometry Shader, language=C]{Code/compute_shader.c}
\end{frame}
