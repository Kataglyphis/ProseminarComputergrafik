...
\begin{frame}
  ...
  \lstinputlisting[label = Shading im Geometry Shader, language=C, style=CStyle]{Code/vertex_shader.c}
\end{frame}
...
\begin{frame}
  ...
  \lstinputlisting[label = Shading im Geometry Shader, language=C, style=CStyle]{Code/geometry_shading.c}
\end{frame}

\begin{frame}
  \frametitle{Geometry Shader und Shading}
  \lstinputlisting[label = Shading im Geometry Shader, language=C, style=CStyle]{Code/geometry_shading2.c}
\end{frame}
...
\begin{frame}
  ...
  \lstinputlisting[label = Shading im Geometry Shader, language=C, style=CStyle]{Code/fragment_shading.c}
...
\begin{frame}
  ...
  \end{itemize}
  \begin{centering}
    \hspace*{2cm}\includegraphics[width=0.7\textwidth]{Bilder/ComputeShader.pdf}
  \end{centering}
...
\begin{frame}
  \frametitle{Compute Shader}
  \lstinputlisting[label = Shading im Geometry Shader, language=C, style=CStyle]{Code/compute_shader.c}
\end{frame}
